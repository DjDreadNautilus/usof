...
router.patch("/:comment_id", authenticateAccessToken, checkRights(Comment, "comment_id"), CommentController.updateComment);

router.delete("/:comment_id", authenticateAccessToken, checkRights(Comment, "comment_id"), CommentController.delete);
